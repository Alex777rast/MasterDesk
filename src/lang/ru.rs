...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Possibly incorrect date and time on the PC. Please check.", "Возможно, неправильная дата и время на ПК, проверьте"),
        ...
        ("Peak speed", "Пиковая скорость"),
        ("Elapsed", "Прошло времени"),
        ("Estimated time remaining", "Примерно осталось"),
        ("Configured workers", "Настроено потоков"),
        ("Target workers", "Целевых потоков"),
        ("Open connections", "Открыто соединений"),
        ("Active workers", "Активных потоков"),
        ("Busy workers", "Занятых потоков"),
        ("Queued jobs", "Заданий в очереди"),
        ("Completed jobs", "Заданий выполнено"),
        ("Auto scaling", "Масштабирование Auto"),
        ("Transferring", "Передача"),
        ("Awaiting confirmation", "Ожидание подтверждения"),
        ("Completed", "Завершено"),
        ("Preparing", "Подготовка"),
        ("Legacy fallback", "Переход в обычный режим"),
        ("Parallel streams", "Параллельные потоки"),
        ("Single stream", "Один поток"),
        ("Legacy mode", "Обычный режим"),
        ("Jobs", "Задания"),
        ("Chunks", "Блоки"),
        ("Files copied", "Скопировано файлов"),
        ("Copied", "Скопировано"),
        ("Time", "За время"),
        ("Transfer diagnostics", "Диагностика передачи"),
        ("Failed to transfer dropped files", "Не удалось передать перетащенные файлы"),
        ...
        ("Plugins", "Плагины"),
        ("Uninstall", "Удалить"),
        ("Delete program settings", "Удалить настройки программы"),
        ("The ID and settings will be deleted. The next clean installation will be registered as a new device.", "ID и настройки будут удалены. Следующая чистая установка будет зарегистрирована как новое устройство."),
        ("Update", "Обновить"),
        ("Enable", "Включить"),
        ("Disable", "Отключить"),
        ("Options", "Настройки"),
