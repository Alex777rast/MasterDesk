...
const String kOptionParallelFileTransferMode = "parallel-file-transfer-mode";
const List<String> kParallelFileTransferModes = <String>[
  'off',
  'auto',
  '2',
  '4',
...
String normalizeParallelFileTransferMode(String value) {
  final normalized = value.trim().toLowerCase();
  return kParallelFileTransferModes.contains(normalized) ? normalized : 'auto';
}

String parallelFileTransferModeLabel(String value) {
  switch (normalizeParallelFileTransferMode(value)) {
    case 'off':
      return '1×';
    case 'auto':
      return translate('Auto');
    default:
      return '${normalizeParallelFileTransferMode(value)}×';
  }
}
